...
tags:
  - JavaScript
  - R
lastmod: '2020-11-05T13:23:26+02:00'
---

<font color="red"> Actualización: 05-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.
...
fechaactual <-   "2020-11-05" #para las etiquetas 
fechasemaforo <- "2020-11-05"
fechacentro <-   "2020-11-04"
fechamapa <-     "2020-11-04"
```
...
`A 04-11-2020 en el Área Sanitaria de Santiago se detectaron 81 nuevos casos y se dieron de alta a 92 y falleció una persona, lo que da lugar a 12 casos activos menos respecto al día 04-11-2020.`
...
*Nota: Hay aulas cerradas o positivos que no están siendo reportados por el SERGAS*
...
Puedes consultar los Centros Educativos de otros Concellos en este [enlace](https://javier-kniffki.shinyapps.io/CentrosEduCovid/).
