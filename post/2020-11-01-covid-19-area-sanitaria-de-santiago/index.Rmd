...
tags:
  - JavaScript
  - R
lastmod: '2020-11-03T13:23:26+02:00'
---

<font color="red"> Actualización: 03-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.
...
fechaactual <-   "2020-11-03" #para las etiquetas 
fechasemaforo <- "2020-11-03"
fechacentro <-   "2020-11-03"
fechamapa <-     "2020-10-31"
```
...
`A 03-11-2020 en el Área Sanitaria de Santiago se detectaron 56 nuevos casos, se dieron de alta a 66 y fallecieron 2 personas, lo que da lugar a 12 casos activos menos respecto al día 02-11-2020.`
