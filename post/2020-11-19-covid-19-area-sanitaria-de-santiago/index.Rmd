...
tags:
  - JavaScript
  - R
lastmod: '2021-04-18T13:24:26+02:00'
---

<font color="red"> Actualización: 18-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-18" #para las etiquetas 
fechasemaforo <- "2021-04-18"
fsantiago <-     "2021-04-18"  
...
`A  18-04-2021 en el Área Sanitaria de Santiago se detectaron 16 nuevos casos, fallecieron 0 personas y se dieron de alta a 24, lo que da lugar a 8 casos activos menos respecto al día 17-04-2021.` 
