...
tags:
  - JavaScript
  - R
lastmod: '2021-04-21T13:24:26+02:00'
---

<font color="red"> Actualización: 21-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-21" #para las etiquetas 
fechasemaforo <- "2021-04-21"
fsantiago <-     "2021-04-21"  

#Centros 
fechacentro <-   "2021-04-20"
fechamapa <-     "2021-04-20"
```
...
`A  21-04-2021 en el Área Sanitaria de Santiago se detectaron 23 nuevos casos, fallecieron 0 personas y se dieron de alta a 17, lo que da lugar a 6 casos activos más respecto al día 19-04-2021.` 
