...
tags:
  - JavaScript
  - R
lastmod: '2020-12-29T13:24:26+02:00'
---

<font color="red"> Actualización: 29-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-29" #para las etiquetas 
fechasemaforo <- "2020-12-29"
fsantiago <-     "2020-12-29"  
...
`A  29-12-2020 en el Área Sanitaria de Santiago se detectaron 72 nuevos casos, se dieron de alta a 79 y fallecieron 4 personas, lo que da lugar a 11 casos activos menos respecto al día 28-12-2020.`
