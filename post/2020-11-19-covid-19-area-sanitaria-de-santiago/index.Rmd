...
tags:
  - JavaScript
  - R
lastmod: '2021-04-15T13:24:26+02:00'
---

<font color="red"> Actualización: 15-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-15" #para las etiquetas 
fechasemaforo <- "2021-04-15"
fsantiago <-     "2021-04-15"  

#Centros 
fechacentro <-   "2021-04-13"
fechamapa <-     "2021-04-13"
```
...
`A  15-04-2021 en el Área Sanitaria de Santiago se detectaron 22 nuevos casos, fallecieron 0 personas y se dieron de alta a 26, lo que da lugar a 4 casos activos menos respecto al día 14-04-2021.` 
