...
tags:
  - JavaScript
  - R
lastmod: '2021-06-03T13:24:26+02:00'
---

<font color="red"> Actualización: 03-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-03" #para las etiquetas 
fechasemaforo <- "2021-06-03"
fsantiago <-     "2021-06-03"  

#Centros 
fechacentro <-   "2021-06-02"
fechamapa <-     "2021-06-02"
```
...
`A  03-06-2021 en el Área Sanitaria de Santiago se detectaron 12 nuevos casos, fallecieron 0 personas y se dieron de alta a 42, lo que da lugar a 30 casos activos menos respecto al día 02-06-2021.` 
