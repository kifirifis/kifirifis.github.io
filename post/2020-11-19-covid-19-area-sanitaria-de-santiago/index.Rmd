...
tags:
  - JavaScript
  - R
lastmod: '2021-03-05T13:24:26+02:00'
---

<font color="red"> Actualización: 05-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-05" #para las etiquetas 
fechasemaforo <- "2021-03-05"
fsantiago <-     "2021-03-05"  

#Centros 
fechacentro <-   "2021-03-04"
fechamapa <-     "2021-03-04"
```
...
`A  05-03-2021 en el Área Sanitaria de Santiago se detectaron 29 nuevos casos, fallecieron 0 personas y se dieron de alta a 38, lo que da lugar a 9 casos activos menos respecto al día 04-03-2021.` 
