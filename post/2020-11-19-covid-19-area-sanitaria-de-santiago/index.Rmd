...
tags:
  - JavaScript
  - R
lastmod: '2021-01-24T13:24:26+02:00'
---

<font color="red"> Actualización: 24-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-24" #para las etiquetas 
fechasemaforo <- "2021-01-24"
fsantiago <-     "2021-01-24"  
...
`A  24-01-2021 en el Área Sanitaria de Santiago se detectaron 159 nuevos casos y se dieron de alta a 182, lo que da lugar a 23 casos activos menos respecto al día 23-01-2021.` 
