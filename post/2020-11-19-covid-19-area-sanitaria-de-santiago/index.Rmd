...
tags:
  - JavaScript
  - R
lastmod: '2021-06-14T13:24:26+02:00'
---

<font color="red"> Actualización: 14-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-14" #para las etiquetas 
fechasemaforo <- "2021-06-14"
fsantiago <-     "2021-06-14"  
...
`A  14-06-2021 en el Área Sanitaria de Santiago se detectaron 5 nuevos casos, fallecieron 0 personas y se dieron de alta a 18, lo que da lugar a 13 casos activos menos respecto al día 13-06-2021.`
