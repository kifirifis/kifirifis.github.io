...
tags:
  - JavaScript
  - R
lastmod: '2021-02-16T13:24:26+02:00'
---

<font color="red"> Actualización: 16-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-16" #para las etiquetas 
fechasemaforo <- "2021-02-16"
fsantiago <-     "2021-02-16"  
...
`A  16-02-2021 en el Área Sanitaria de Santiago se detectaron 39 nuevos casos, fallecieron 2 personas y se dieron de alta a 116, lo que da lugar a 79 casos activos menos respecto al día 15-02-2021.` 
