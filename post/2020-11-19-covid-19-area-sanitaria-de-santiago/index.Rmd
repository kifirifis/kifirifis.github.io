...
tags:
  - JavaScript
  - R
lastmod: '2021-03-14T13:24:26+02:00'
---

<font color="red"> Actualización: 14-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-14" #para las etiquetas 
fechasemaforo <- "2021-03-14"
fsantiago <-     "2021-03-14"  

#Centros 
fechacentro <-   "2021-03-12"
fechamapa <-     "2021-03-12"
```
...
`A  14-03-2021 en el Área Sanitaria de Santiago se detectaron 8 nuevos casos, fallecieron 5 personas y se dieron de alta a 17, lo que da lugar a 14 casos activos menos respecto al día 13-03-2021.` 
