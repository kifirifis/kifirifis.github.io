...
tags:
  - JavaScript
  - R
lastmod: '2021-04-06T13:24:26+02:00'
---

<font color="red"> Actualización: 06-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-06" #para las etiquetas 
fechasemaforo <- "2021-04-06"
fsantiago <-     "2021-04-06"  
...
`A  06-04-2021 en el Área Sanitaria de Santiago se detectaron 24 nuevos casos, falleció 1 persona y se dieron de alta a 5, lo que da lugar a 18 casos activos más respecto al día 05-04-2021.` 
