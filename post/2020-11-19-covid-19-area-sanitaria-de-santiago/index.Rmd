...
tags:
  - JavaScript
  - R
lastmod: '2021-01-28T13:24:26+02:00'
---

<font color="red"> Actualización: 28-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-28" #para las etiquetas 
fechasemaforo <- "2021-01-28"
fsantiago <-     "2021-01-28"  
...
`A  28-01-2021 en el Área Sanitaria de Santiago se detectaron 197 nuevos casos, se dieron de alta a 231 y fallecieron 3 personas, lo que da lugar a 37 casos activos menos respecto al día 27-01-2021.` 
