...
tags:
  - JavaScript
  - R
lastmod: '2020-12-02T13:23:26+02:00'
---

<font color="red"> Actualización: 02-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-02" #para las etiquetas 
fechasemaforo <- "2020-12-02"
fechacentro <-   "2020-12-02"
fechamapa <-     "2020-12-02"
```
...
`A  02-12-2020 en el Área Sanitaria de Santiago se detectaron 58 nuevos casos, se dieron de alta a 69, lo que da lugar a 11 casos activos menos respecto al día 01-12-2020.`
