...
tags:
  - JavaScript
  - R
lastmod: '2021-05-26T13:24:26+02:00'
---

<font color="red"> Actualización: 26-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-26" #para las etiquetas 
fechasemaforo <- "2021-05-26"
fsantiago <-     "2021-05-26"  

#Centros 
fechacentro <-   "2021-05-25"
fechamapa <-     "2021-05-25"
```
...
`A  26-05-2021 en el Área Sanitaria de Santiago se detectaron 27 nuevos casos, fallecieron 0 personas y se dieron de alta a 47, lo que da lugar a 20 casos activos menos respecto al día 25-05-2021.` 
