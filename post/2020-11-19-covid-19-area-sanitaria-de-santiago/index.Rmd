...
tags:
  - JavaScript
  - R
lastmod: '2020-12-18T13:23:26+02:00'
---

<font color="red"> Actualización: 18-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-18" #para las etiquetas 
fechasemaforo <- "2020-12-18"
fechacentro <-   "2020-12-17"
fechamapa <-     "2020-12-17"
```
...
`A  18-12-2020 en el Área Sanitaria de Santiago se detectaron 104 nuevos casos, falleció una persona y se dieron de alta a 60, lo que da lugar a 43 casos activos más respecto al día 16-12-2020.`

`- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima.`

`- La tasa "Número de casos notificados por cada cien mil habitantes en los últimos 14 días" NO es óptima.`
...
ggplot() +
        ...
        labs(x = "", y = "", title = "Proporción PCR+ Media móvil 14 días",
        ...
        annotate("text", x = as_date("2020-09-04"), y = 1, label = "Vuelta al Cole", size = 2) + 
        annotate("text", x = as_date("2020-09-26"), y = 1, label = "Vuelta USC", size = 2) + 
        ...
        annotate("text", x = as_date("2020-10-23"), y = 2, 
        ...
        annotate("text", x = as_date("2020-11-14"), y = 2, label = "Cierre hostelería", size = 2) +
            # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-26"), y = 0.8, label = "Apertura hostelería", size = 2) + 
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-09-04"), y = 25, label = "Vuelta al Cole", size = 2) + 
        annotate("text", x = as_date("2020-09-26"), y = 25, label = "Vuelta USC", size = 2) + 
  
        #Eventos poíticos y económicos
          #Cierre consumo interior bares https://www.lavozdegalicia.es/retransmision/sociedad/2020/10/30/directo-sanidade-anuncia-nuevas-restricciones-galicia/01071604049077150195336.htm
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-23"), y = 70, 
                 label = "Prohibición de \n consumo en interiores\n de bares en Santiago", size = 2) + 
  
          # Cierre hostelería
        geom_vline(xintercept = as_date("2020-11-07"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-14"), y = 55, label = "Cierre hostelería", size = 2) + 
        
          # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-26"), y = 25, label = "Apertura hostelería", size = 2) + 
...
ggplot() +
        ...
        geom_point_interactive(data = datos, 
                               aes(tooltip = paste0("Activos Media M. 7d: ", MA7, "\nFecha: ", fecha), 
                                   fecha, MA7, colour = "#B22222"),
                               size = 3) +
...
ggplot() +
        ...
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-02"), y = 170, label = "Apertura hostelería", size = 2) +
        
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-17"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-15"), y = 170, label = "Cierre perimetral y \n reducción de aforo", size = 2) +
