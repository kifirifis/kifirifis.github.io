...
tags:
  - JavaScript
  - R
lastmod: '2021-05-23T13:24:26+02:00'
---

<font color="red"> Actualización: 23-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-23" #para las etiquetas 
fechasemaforo <- "2021-05-23"
fsantiago <-     "2021-05-23"  
...
`A  23-05-2021 en el Área Sanitaria de Santiago se detectaron 33 nuevos casos, fallecieron 0 personas y se dieron de alta a 15, lo que da lugar a 18 casos activos más respecto al día 22-05-2021.` 
