...
tags:
  - JavaScript
  - R
lastmod: '2021-01-30T13:24:26+02:00'
---

<font color="red"> Actualización: 30-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-30" #para las etiquetas 
fechasemaforo <- "2021-01-30"
fsantiago <-     "2021-01-30"  
...
`A  30-01-2021 en el Área Sanitaria de Santiago se detectaron 266 nuevos casos, se dieron de alta a 191 y fallecieron 3 personas, lo que da lugar a 72 casos activos más respecto al día 29-01-2021.` 
