...
tags:
  - JavaScript
  - R
lastmod: '2020-12-11T13:23:26+02:00'
---

<font color="red"> Actualización: 11-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-11" #para las etiquetas 
fechasemaforo <- "2020-12-11"
...
`A  11-12-2020 en el Área Sanitaria de Santiago se detectaron 66 nuevos casos y se dieron de alta a 58 y falleció una persona, lo que da lugar a 7 casos activos más respecto al día 10-12-2020.`

`- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima.`

`- La tasa "Número de casos notificados por cada cien mil habitantes en los últimos 14 días" NO es óptima y se encuentra en la categoría "Riesgo muy alto".`
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-10-24"), y = 2, 
                 label = "Cierre consumo en \n interiores de bares \n  Santiago", size = 2) +
...
ggplot() +
        ...
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-24"), y = 70, 
                 label = "Cierre consumo en \n interiores de bares \n  Santiago", size = 2) + 
