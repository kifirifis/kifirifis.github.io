...
tags:
  - JavaScript
  - R
lastmod: '2021-01-23T13:24:26+02:00'
---

<font color="red"> Actualización: 23-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-23" #para las etiquetas 
fechasemaforo <- "2021-01-23"
fsantiago <-     "2021-01-23"  
...
`A  23-01-2021 en el Área Sanitaria de Santiago se detectaron 253 nuevos casos, se dieron de alta a 147 y fallecieron 3 personas, lo que da lugar a 103 casos activos más respecto al día 21-01-2021.` 
...
ggplot() +
        ...
        expand_limits(x = as_date("2021-02-05")) -> gg4
...
ggplot() +
        ...
        expand_limits(x = as_date("2021-02-05")) -> gg9
...
ggplot() +
        ...
        # Escalas
        scale_alpha_identity(guide = "none") +
        scale_y_continuous(expand = c(0, 0), limits = c(0, 670)) +
        scale_x_date(date_minor_breaks = "week", date_breaks = "week", date_labels = "%b %d") +
        ...
        annotate("text", x = as_date("2020-12-13"), y = 38, 
                 label = "Cierre perimetral y \n reducción de aforo", size = 2) +
        
        # Navidad
        geom_vline(xintercept = as_date("2020-12-25"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-23"), y = 38, 
        ...
        expand_limits(x = as_date("2021-01-18")) -> p50
