...
tags:
  - JavaScript
  - R
lastmod: '2021-05-01T13:24:26+02:00'
---

<font color="red"> Actualización: 01-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-01" #para las etiquetas 
fechasemaforo <- "2021-05-01"
fsantiago <-     "2021-05-01"  

#Centros 
fechacentro <-   "2021-04-30"
fechamapa <-     "2021-04-30"
```
...
`A  01-05-2021 en el Área Sanitaria de Santiago se detectaron 26 nuevos casos, fallecieron 0 personas y se dieron de alta a 30, lo que da lugar a 4 casos activos menos respecto al día 30-04-2021.` 
