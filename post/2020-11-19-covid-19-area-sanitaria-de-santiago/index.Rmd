...
tags:
  - JavaScript
  - R
lastmod: '2021-01-31T13:24:26+02:00'
---

<font color="red"> Actualización: 31-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-31" #para las etiquetas 
fechasemaforo <- "2021-01-31"
fsantiago <-     "2021-01-31"  
...
`A  31-01-2021 en el Área Sanitaria de Santiago se detectaron 176 nuevos casos y se dieron de alta a 196, lo que da lugar a 20 casos activos menos respecto al día 30-01-2021.` 
