...
tags:
  - JavaScript
  - R
lastmod: '2021-01-25T13:24:26+02:00'
---

<font color="red"> Actualización: 25-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-25" #para las etiquetas 
fechasemaforo <- "2021-01-25"
fsantiago <-     "2021-01-25"  
...
`A  25-01-2021 en el Área Sanitaria de Santiago se detectaron 294 nuevos casos y se dieron de alta a 99, lo que da lugar a 195 casos activos más respecto al día 23-01-2021.` 
