...
tags:
  - JavaScript
  - R
lastmod: '2021-02-20T13:24:26+02:00'
---

<font color="red"> Actualización: 20-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-20" #para las etiquetas 
fechasemaforo <- "2021-02-20"
fsantiago <-     "2021-02-20"  

#Centros 
fechacentro <-   "2021-02-20"
fechamapa <-     "2021-02-20"
```
...
`A  20-02-2021 en el Área Sanitaria de Santiago se detectaron 50 nuevos casos, fallecieron 6 personas y se dieron de alta a 149, lo que da lugar a 105 casos activos menos respecto al día 18-02-2021.` 
