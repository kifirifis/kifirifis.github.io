...
tags:
  - JavaScript
  - R
lastmod: '2021-01-08T13:24:26+02:00'
---

<font color="red"> Actualización: 08-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-08" #para las etiquetas 
fechasemaforo <- "2021-01-08"
fsantiago <-     "2021-01-08"  
...
`A  08-01-2021 en el Área Sanitaria de Santiago se detectaron 179 nuevos casos y se dieron de alta a 115, lo que da lugar a 64 casos activos más respecto al día 07-01-2021.` 
