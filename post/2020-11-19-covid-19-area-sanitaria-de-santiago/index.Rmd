...
tags:
  - JavaScript
  - R
lastmod: '2021-04-22T13:24:26+02:00'
---

<font color="red"> Actualización: 22-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-22" #para las etiquetas 
fechasemaforo <- "2021-04-22"
fsantiago <-     "2021-04-22"  

#Centros 
fechacentro <-   "2021-04-21"
fechamapa <-     "2021-04-21"
```
...
`A  22-04-2021 en el Área Sanitaria de Santiago se detectaron 10 nuevos casos, fallecieron 0 personas y se dieron de alta a 21, lo que da lugar a 11 casos activos menos respecto al día 21-04-2021.` 
