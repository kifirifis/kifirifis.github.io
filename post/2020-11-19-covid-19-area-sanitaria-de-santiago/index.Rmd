...
tags:
  - JavaScript
  - R
lastmod: '2021-02-18T13:24:26+02:00'
---

<font color="red"> Actualización: 18-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-18" #para las etiquetas 
fechasemaforo <- "2021-02-18"
fsantiago <-     "2021-02-18"  
...
`A  18-02-2021 en el Área Sanitaria de Santiago se detectaron 40 nuevos casos, fallecieron 0 personas y se dieron de alta a 159, lo que da lugar a 119 casos activos menos respecto al día 17-02-2021.` 

<img src="rbajo.png" style="display: inline-block; margin: 0" />  `- La tasa "Proporción PCR+ Media móvil 14 días" está en la categoría 'Riesgo de transmisión bajo'.`
