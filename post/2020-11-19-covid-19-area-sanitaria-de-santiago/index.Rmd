...
tags:
  - JavaScript
  - R
lastmod: '2021-05-29T13:24:26+02:00'
---

<font color="red"> Actualización: 29-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-29" #para las etiquetas 
fechasemaforo <- "2021-05-29"
fsantiago <-     "2021-05-29"  

#Centros 
fechacentro <-   "2021-05-28"
fechamapa <-     "2021-05-28"
```
...
`A  29-05-2021 en el Área Sanitaria de Santiago se detectaron 16 nuevos casos, fallecieron 0 personas y se dieron de alta a 31, lo que da lugar a 15 casos activos menos respecto al día 28-05-2021.` 
