...
tags:
  - JavaScript
  - R
lastmod: '2021-03-11T13:24:26+02:00'
---

<font color="red"> Actualización: 11-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-11" #para las etiquetas 
fechasemaforo <- "2021-03-11"
fsantiago <-     "2021-03-11"  

#Centros 
fechacentro <-   "2021-03-10"
fechamapa <-     "2021-03-10"
```
...
`A  11-03-2021 en el Área Sanitaria de Santiago se detectaron 12 nuevos casos, fallecieron 0 personas y se dieron de alta a 45, lo que da lugar a 33 casos activos menos respecto al día 09-03-2021.` 
