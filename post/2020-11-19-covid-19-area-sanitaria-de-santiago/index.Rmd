...
tags:
  - JavaScript
  - R
lastmod: '2021-01-03T13:24:26+02:00'
---

<font color="red"> Actualización: 03-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-03" #para las etiquetas 
fechasemaforo <- "2021-01-03"
fsantiago <-     "2021-01-03"  
...
`A  03-01-2021 en el Área Sanitaria de Santiago se detectaron 66 nuevos casos, dieron de alta a 86 y fallecieron 4 personas, lo que da lugar a 24 casos activos menos respecto al día 02-01-2021.` 

<img src="rmoderado.png" style="display: inline-block; margin: 0" />  `- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima.`
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-09-27"), y = 1, label = "Vuelta USC", size = 2) + 
        ...
        annotate("text", x = as_date("2020-11-24"), y = 0.8, label = "Apertura hostelería", size = 2) + 
        ...
        annotate("text", x = as_date("2021-01-05"), y = 0.8, label = "Año\nNuevo", size = 2) + 
...
ggplot() +
        ...
        # Vuelta USC
        geom_vline(xintercept = as_date("2020-09-21"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-09-27"), y = 25, label = "Vuelta USC", size = 2) + 
        ...
        annotate("text", x = as_date("2020-11-16"), y = 55, label = "Cierre hostelería", size = 2) + 
          ...
          # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-24"), y = 25, label = "Apertura hostelería", size = 2) + 
        ...
        annotate("text", x = as_date("2020-12-20"), y = 25, label = "Navidad", size = 2) + 
          ...
          # Año nuevo 
        geom_vline(xintercept = as_date("2021-01-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-01-05"), y = 30, label = "Año\nNuevo", size = 2) + 
...
ggplot() +
        ...
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-01"), y = 40, label = "Apertura hostelería", size = 2) +
        
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-17"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-14"), y = 40, 
        ...
        expand_limits(x = as_date("2020-12-25")) -> p50
