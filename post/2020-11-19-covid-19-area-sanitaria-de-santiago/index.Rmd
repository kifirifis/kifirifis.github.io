...
tags:
  - JavaScript
  - R
lastmod: '2021-01-13T13:24:26+02:00'
---

<font color="red"> Actualización: 13-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-13" #para las etiquetas 
fechasemaforo <- "2021-01-13"
fsantiago <-     "2021-01-13"  

#Centros 
fechacentro <-   "2021-01-12"
fechamapa <-     "2021-01-12"
```
...
`A  13-01-2021 en el Área Sanitaria de Santiago se detectaron 195 nuevos casos, se dieron de alta a 111 y fallecieron 9 personas, lo que da lugar a 75 casos activos más respecto al día 12-01-2021.` 
