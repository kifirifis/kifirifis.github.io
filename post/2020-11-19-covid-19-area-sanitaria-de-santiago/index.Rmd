...
tags:
  - JavaScript
  - R
lastmod: '2021-02-09T13:24:26+02:00'
---

<font color="red"> Actualización: 09-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-09" #para las etiquetas 
fechasemaforo <- "2021-02-09"
fsantiago <-     "2021-02-09"  

#Centros 
fechacentro <-   "2021-02-06"
fechamapa <-     "2021-02-06"
```
...
`A  09-02-2021 en el Área Sanitaria de Santiago se detectaron 61 nuevos casos, se dieron de alta a 268 y fallecieron 2 personas, lo que da lugar a 209 casos activos menos respecto al día 08-02-2021.` 
