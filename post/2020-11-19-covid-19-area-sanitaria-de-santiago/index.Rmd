...
<font color="red"> Actualización: 07-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-07" #para las etiquetas 
fechasemaforo <- "2021-02-07"
fsantiago <-     "2021-02-07"  
...
`A  07-02-2021 en el Área Sanitaria de Santiago se detectaron 108 nuevos casos, se dieron de alta a 267 y falleció 1 persona, lo que da lugar a 160 casos activos menos respecto al día 06-02-2021.` 
