...
tags:
  - JavaScript
  - R
lastmod: '2021-05-07T13:24:26+02:00'
---

<font color="red"> Actualización: 07-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-07" #para las etiquetas 
fechasemaforo <- "2021-05-07"
fsantiago <-     "2021-05-07"  

#Centros 
fechacentro <-   "2021-05-06"
fechamapa <-     "2021-05-06"
```
...
`A  07-05-2021 en el Área Sanitaria de Santiago se detectaron 25 nuevos casos, fallecieron 0 personas y se dieron de alta a 12, lo que da lugar a 13 casos activos más respecto al día 06-05-2021.` 
