...
tags:
  - JavaScript
  - R
lastmod: '2021-01-18T13:24:26+02:00'
---

<font color="red"> Actualización: 18-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-18" #para las etiquetas 
fechasemaforo <- "2021-01-18"
fsantiago <-     "2021-01-18"  
...
`A  18-01-2021 en el Área Sanitaria de Santiago se detectaron 140 nuevos casos, se dieron de alta a 42 y fallecieron 2 personas, lo que da lugar a 96 casos activos más respecto al día 17-01-2021.` 
