...
tags:
  - JavaScript
  - R
lastmod: '2020-12-31T13:24:26+02:00'
---

<font color="red"> Actualización: 31-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-31" #para las etiquetas 
fechasemaforo <- "2020-12-31"
fsantiago <-     "2020-12-31"  
...
`A  31-12-2020 en el Área Sanitaria de Santiago se detectaron 115 nuevos casos, se dieron de alta a 117 y fallecieron 2 personas, lo que da lugar a 4 casos activos menos respecto al día 30-12-2020.`
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-10-22"), y = 2, 
        ...
        annotate("text", x = as_date("2020-11-15"), y = 2, label = "Cierre hostelería", size = 2) +
  
            # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-25"), y = 0.8, label = "Apertura hostelería", size = 2) + 
        
            # Navidad 
        geom_vline(xintercept = as_date("2020-12-25"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-21"), y = 0.8, label = "Navidad", size = 2) + 
...
ggplot() +
        ...
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-22"), y = 70, 
                 label = "Prohibición de \n consumo en interiores\n de bares en Santiago", size = 2) + 
  
          # Cierre hostelería
        geom_vline(xintercept = as_date("2020-11-07"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-15"), y = 55, label = "Cierre hostelería", size = 2) + 
        
          # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-25"), y = 25, label = "Apertura hostelería", size = 2) + 
        
          # Navidad
        geom_vline(xintercept = as_date("2020-12-25"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-21"), y = 25, label = "Navidad", size = 2) + 
