...
tags:
  - JavaScript
  - R
lastmod: '2021-02-10T13:24:26+02:00'
---

<font color="red"> Actualización: 10-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-10" #para las etiquetas 
fechasemaforo <- "2021-02-10"
fsantiago <-     "2021-02-10"  

#Centros 
fechacentro <-   "2021-02-09"
fechamapa <-     "2021-02-09"
```
...
`A  10-02-2021 en el Área Sanitaria de Santiago se detectaron 91 nuevos casos, se dieron de alta a 269 y fallecieron 4 personas, lo que da lugar a 182 casos activos menos respecto al día 09-02-2021.` 

<img src="rmoderado.png" style="display: inline-block; margin: 0" />  `- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima. Riesgo de transmisión moderado.`
