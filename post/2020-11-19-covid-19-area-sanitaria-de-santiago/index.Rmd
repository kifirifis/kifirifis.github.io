...
tags:
  - JavaScript
  - R
lastmod: '2021-02-01T13:24:26+02:00'
---

<font color="red"> Actualización: 01-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-01" #para las etiquetas 
fechasemaforo <- "2021-02-01"
fsantiago <-     "2021-02-01"  
...
`A  01-02-2021 en el Área Sanitaria de Santiago se detectaron 148 nuevos casos, se dieron de alta a 153 y fallecieron 2 personas, lo que da lugar a 7 casos activos menos respecto al día 31-01-2021.` 
