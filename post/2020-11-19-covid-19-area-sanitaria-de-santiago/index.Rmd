...
tags:
  - JavaScript
  - R
lastmod: '2021-02-19T13:24:26+02:00'
---

<font color="red"> Actualización: 19-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-19" #para las etiquetas 
fechasemaforo <- "2021-02-19"
fsantiago <-     "2021-02-19"  
...
`A  19-02-2021 en el Área Sanitaria de Santiago se detectaron 38 nuevos casos, fallecieron 5 personas y se dieron de alta a 235, lo que da lugar a 201 casos activos menos respecto al día 18-02-2021.` 
