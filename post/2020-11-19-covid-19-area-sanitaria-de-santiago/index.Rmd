...
tags:
  - JavaScript
  - R
lastmod: '2021-01-15T13:24:26+02:00'
---

<font color="red"> Actualización: 15-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-15" #para las etiquetas 
fechasemaforo <- "2021-01-15"
fsantiago <-     "2021-01-15"  
...
`A  15-01-2021 en el Área Sanitaria de Santiago se detectaron 210 nuevos casos, se dieron de alta a 111 y falleció una persona, lo que da lugar a 98 casos activos más respecto al día 14-01-2021.` 
