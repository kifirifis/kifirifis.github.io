...
tags:
  - JavaScript
  - R
lastmod: '2021-02-05T13:24:26+02:00'
---

<font color="red"> Actualización: 05-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-05" #para las etiquetas 
fechasemaforo <- "2021-02-05"
fsantiago <-     "2021-02-05"  
...
`A  05-02-2021 en el Área Sanitaria de Santiago se detectaron 172 nuevos casos, se dieron de alta a 249 y fallecieron 3 personas, lo que da lugar a 80 casos activos menos respecto al día 04-02-2021.` 
