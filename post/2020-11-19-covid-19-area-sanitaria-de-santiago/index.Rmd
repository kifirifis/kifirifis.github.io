...
tags:
  - JavaScript
  - R
lastmod: '2020-12-10T13:23:26+02:00'
---

<font color="red"> Actualización: 10-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-10" #para las etiquetas 
fechasemaforo <- "2020-12-10"
...
`A  10-12-2020 en el Área Sanitaria de Santiago se detectaron 77 nuevos casos y se dieron de alta a 45, lo que da lugar a 32 casos activos más respecto al día 09-12-2020.`
