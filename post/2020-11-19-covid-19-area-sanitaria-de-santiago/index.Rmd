...
tags:
  - JavaScript
  - R
lastmod: '2020-12-12T13:23:26+02:00'
---

<font color="red"> Actualización: 12-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-12" #para las etiquetas 
fechasemaforo <- "2020-12-12"
fechacentro <-   "2020-12-11"
fechamapa <-     "2020-12-11"
```
...
`A  12-12-2020 en el Área Sanitaria de Santiago se detectaron 91 nuevos casos y se dieron de alta a 63 y falleció una persona, lo que da lugar a 27 casos activos más respecto al día 11-12-2020.`
...
Positivos en Centros Educativos notificados a `r fechamapa` (No necesariamente alumnos si no personas vinculadas al Centro Educativo)
