...
tags:
  - JavaScript
  - R
lastmod: '2021-01-27T13:24:26+02:00'
---

<font color="red"> Actualización: 27-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-27" #para las etiquetas 
fechasemaforo <- "2021-01-27"
fsantiago <-     "2021-01-27"  
...
`A  27-01-2021 en el Área Sanitaria de Santiago se detectaron 225 nuevos casos, se dieron de alta a 156 y fallecieron 2 personas, lo que da lugar a 67 casos activos más respecto al día 23-01-2021.` 
