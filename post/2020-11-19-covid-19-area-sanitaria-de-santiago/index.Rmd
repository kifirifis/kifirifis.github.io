...
tags:
  - JavaScript
  - R
lastmod: '2020-11-30T13:23:26+02:00'
---

<font color="red"> Actualización: 30-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-11-30" #para las etiquetas 
fechasemaforo <- "2020-11-30"
...
`A  30-11-2020 en el Área Sanitaria de Santiago se detectaron 26 nuevos casos, se dieron de alta a 32, lo que da lugar a 6 casos activos menos respecto al día 29-11-2020.`
