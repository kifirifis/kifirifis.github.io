...
tags:
  - JavaScript
  - R
lastmod: '2021-01-21T13:24:26+02:00'
---

<font color="red"> Actualización: 21-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-21" #para las etiquetas 
fechasemaforo <- "2021-01-21"
fsantiago <-     "2021-01-21"  

#Centros 
fechacentro <-   "2021-01-20"
fechamapa <-     "2021-01-20"
```
...
`A  21-01-2021 en el Área Sanitaria de Santiago se detectaron 233 nuevos casos, se dieron de alta a 129 y fallecieron 3 personas, lo que da lugar a 101 casos activos más respecto al día 19-01-2021.` 
