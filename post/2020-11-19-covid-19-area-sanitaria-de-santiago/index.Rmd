...
tags:
  - JavaScript
  - R
lastmod: '2021-02-11T13:24:26+02:00'
---

<font color="red"> Actualización: 11-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-11" #para las etiquetas 
fechasemaforo <- "2021-02-11"
fsantiago <-     "2021-02-11"  

#Centros 
fechacentro <-   "2021-02-11"
fechamapa <-     "2021-02-11"
```
...
`A  11-02-2021 en el Área Sanitaria de Santiago se detectaron 75 nuevos casos, se dieron de alta a 257 y fallecieron 2 personas, lo que da lugar a 184 casos activos menos respecto al día 10-02-2021.` 
