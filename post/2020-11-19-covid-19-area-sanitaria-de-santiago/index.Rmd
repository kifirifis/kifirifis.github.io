...
tags:
  - JavaScript
  - R
lastmod: '2021-04-05T13:24:26+02:00'
---

<font color="red"> Actualización: 05-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-05" #para las etiquetas 
fechasemaforo <- "2021-04-05"
fsantiago <-     "2021-04-05"  
...
`A  05-04-2021 en el Área Sanitaria de Santiago se detectaron 26 nuevos casos, fallecieron 0 personas y se dieron de alta a 14, lo que da lugar a 12 casos activos más respecto al día 04-04-2021.` 
