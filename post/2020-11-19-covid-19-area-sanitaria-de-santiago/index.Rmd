...
tags:
  - JavaScript
  - R
lastmod: '2021-06-06T13:24:26+02:00'
---

<font color="red"> Actualización: 06-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-06" #para las etiquetas 
fechasemaforo <- "2021-06-06"
fsantiago <-     "2021-06-06"  
...
`A  06-06-2021 en el Área Sanitaria de Santiago se detectaron 10 nuevos casos, fallecieron 2 personas y se dieron de alta a 21, lo que da lugar a 11 casos activos menos respecto al día 05-06-2021.` 
