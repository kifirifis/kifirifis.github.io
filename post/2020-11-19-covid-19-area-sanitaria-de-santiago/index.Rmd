...
tags:
  - JavaScript
  - R
lastmod: '2021-04-12T13:24:26+02:00'
---

<font color="red"> Actualización: 12-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-12" #para las etiquetas 
fechasemaforo <- "2021-04-12"
fsantiago <-     "2021-04-12"  
...
`A  12-04-2021 en el Área Sanitaria de Santiago se detectaron 18 nuevos casos, fallecieron 0 personas y se dieron de alta a 20, lo que da lugar a 2 casos activos menos respecto al día 11-04-2021.` 
