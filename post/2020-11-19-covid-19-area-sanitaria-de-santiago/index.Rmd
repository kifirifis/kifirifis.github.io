...
tags:
  - JavaScript
  - R
lastmod: '2021-04-10T13:24:26+02:00'
---

<font color="red"> Actualización: 10-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-10" #para las etiquetas 
fechasemaforo <- "2021-04-10"
fsantiago <-     "2021-04-10"  

#Centros 
fechacentro <-   "2021-04-09"
fechamapa <-     "2021-04-09"
```
...
`A  10-04-2021 en el Área Sanitaria de Santiago se detectaron 32 nuevos casos, falleció 1 persona y se dieron de alta a 13, lo que da lugar a 18 casos activos más respecto al día 09-04-2021.` 
