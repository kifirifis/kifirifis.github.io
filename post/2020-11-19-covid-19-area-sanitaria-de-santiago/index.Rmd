...
tags:
  - JavaScript
  - R
lastmod: '2021-06-05T13:24:26+02:00'
---

<font color="red"> Actualización: 05-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-05" #para las etiquetas 
fechasemaforo <- "2021-06-05"
fsantiago <-     "2021-06-05"  

#Centros 
fechacentro <-   "2021-06-04"
fechamapa <-     "2021-06-04"
```
...
`A  05-06-2021 en el Área Sanitaria de Santiago se detectaron 10 nuevos casos, fallecieron 2 personas y se dieron de alta a 32, lo que da lugar a 24 casos activos menos respecto al día 04-06-2021.` 
