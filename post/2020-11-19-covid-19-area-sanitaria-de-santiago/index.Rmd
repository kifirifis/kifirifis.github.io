...
tags:
  - JavaScript
  - R
lastmod: '2020-12-27T13:24:26+02:00'
---

<font color="red"> Actualización: 27-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-27" #para las etiquetas 
fechasemaforo <- "2020-12-27"
fsantiago <-     "2020-12-27"  
...
`A  27-12-2020 en el Área Sanitaria de Santiago se detectaron 79 nuevos casos, se dieron de alta a 80 y fallecieron 2 personas, lo que da lugar a 3 casos activos menos respecto al día 26-12-2020.`
