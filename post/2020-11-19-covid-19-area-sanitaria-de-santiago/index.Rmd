...
tags:
  - JavaScript
  - R
lastmod: '2021-03-26T13:24:26+02:00'
---

<font color="red"> Actualización: 26-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-26" #para las etiquetas 
fechasemaforo <- "2021-03-26"
fsantiago <-     "2021-03-26"  

#Centros 
fechacentro <-   "2021-03-25"
fechamapa <-     "2021-03-25"
```
...
`A  26-03-2021 en el Área Sanitaria de Santiago se detectaron 8 nuevos casos, falleció 1 persona y se dieron de alta a 6, lo que da lugar a 1 caso activo más respecto al día 25-03-2021.` 
