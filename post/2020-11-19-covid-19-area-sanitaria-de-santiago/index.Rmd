...
tags:
  - JavaScript
  - R
lastmod: '2021-02-12T13:24:26+02:00'
---

<font color="red"> Actualización: 12-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-12" #para las etiquetas 
fechasemaforo <- "2021-02-12"
fsantiago <-     "2021-02-12"  

#Centros 
fechacentro <-   "2021-02-12"
fechamapa <-     "2021-02-12"
```
...
`A  12-02-2021 en el Área Sanitaria de Santiago se detectaron 65 nuevos casos, se dieron de alta a 232 y fallecieron 4 personas, lo que da lugar a 171 casos activos menos respecto al día 11-02-2021.` 
