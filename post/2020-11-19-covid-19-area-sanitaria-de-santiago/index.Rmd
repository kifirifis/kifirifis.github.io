...
tags:
  - JavaScript
  - R
lastmod: '2021-05-05T13:24:26+02:00'
---

<font color="red"> Actualización: 05-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-05" #para las etiquetas 
fechasemaforo <- "2021-05-05"
fsantiago <-     "2021-05-05"  

#Centros 
fechacentro <-   "2021-05-01"
fechamapa <-     "2021-05-01"
```
...
`A  05-05-2021 en el Área Sanitaria de Santiago se detectaron 24 nuevos casos, fallecieron 0 personas y se dieron de alta a 21, lo que da lugar a 3 casos activos más respecto al día 04-05-2021.` 
