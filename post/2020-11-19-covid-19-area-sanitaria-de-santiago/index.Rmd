...
tags:
  - JavaScript
  - R
lastmod: '2020-12-26T13:24:26+02:00'
---

<font color="red"> Actualización: 26-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-26" #para las etiquetas 
fechasemaforo <- "2020-12-26"
fsantiago <-     "2020-12-26"  
...
`A  26-12-2020 en el Área Sanitaria de Santiago se detectaron 99 nuevos casos, se dieron de alta a 64 y fallecieron 3 personas, lo que da lugar a 32 casos activos más respecto al día 25-12-2020.`
