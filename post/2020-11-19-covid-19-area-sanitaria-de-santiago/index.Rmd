...
tags:
  - JavaScript
  - R
lastmod: '2021-01-06T13:24:26+02:00'
---

<font color="red"> Actualización: 06-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-06" #para las etiquetas 
fechasemaforo <- "2021-01-06"
fsantiago <-     "2021-01-06"  
...
`A  06-01-2021 en el Área Sanitaria de Santiago se detectaron 156 nuevos casos, falleció una persona y se dieron de alta a 49, lo que da lugar a 106 casos activos más respecto al día 05-01-2021.` 
