...
tags:
  - JavaScript
  - R
lastmod: '2020-11-25T13:23:26+02:00'
---

<font color="red"> Actualización: 25-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-11-25" #para las etiquetas 
fechasemaforo <- "2020-11-25"
fechacentro <-   "2020-11-25"
fechamapa <-     "2020-11-25"
```
...
`A  25-11-2020 en el Área Sanitaria de Santiago se detectaron 45 nuevos casos, se dieron de alta a 64 y falleció una persona, lo que da lugar a 20 casos activos menos respecto al día 24-11-2020.`
