...
tags:
  - JavaScript
  - R
lastmod: '2020-11-29T13:23:26+02:00'
---

<font color="red"> Actualización: 29-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-11-29" #para las etiquetas 
fechasemaforo <- "2020-11-29"
fechacentro <-   "2020-11-28"
fechamapa <-     "2020-11-28"
```
...
`A  29-11-2020 en el Área Sanitaria de Santiago se detectaron 44 nuevos casos, se dieron de alta a 76, lo que da lugar a 32 casos activos menos respecto al día 28-11-2020.`
