...
tags:
  - JavaScript
  - R
lastmod: '2021-04-24T13:24:26+02:00'
---

<font color="red"> Actualización: 24-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-24" #para las etiquetas 
fechasemaforo <- "2021-04-24"
fsantiago <-     "2021-04-24"  

#Centros 
fechacentro <-   "2021-04-23"
fechamapa <-     "2021-04-23"
```
...
`A  24-04-2021 en el Área Sanitaria de Santiago se detectaron 27 nuevos casos, fallecieron 0 personas y se dieron de alta a 20, lo que da lugar a 7 casos activos más respecto al día 23-04-2021.` 
