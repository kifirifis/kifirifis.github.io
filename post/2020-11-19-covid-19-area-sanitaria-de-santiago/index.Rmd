...
tags:
  - JavaScript
  - R
lastmod: '2021-02-06T13:24:26+02:00'
---

<font color="red"> Actualización: 06-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-06" #para las etiquetas 
fechasemaforo <- "2021-02-06"
fsantiago <-     "2021-02-06"  
...
`A  06-02-2021 en el Área Sanitaria de Santiago se detectaron 130 nuevos casos, se dieron de alta a 282 y fallecieron 4 personas, lo que da lugar a 156 casos activos menos respecto al día 05-02-2021.` 
