...
tags:
  - JavaScript
  - R
lastmod: '2021-01-05T13:24:26+02:00'
---

<font color="red"> Actualización: 05-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-05" #para las etiquetas 
fechasemaforo <- "2021-01-05"
fsantiago <-     "2021-01-05"  
...
`A  05-01-2021 en el Área Sanitaria de Santiago se detectaron 60 nuevos casos y se dieron de alta a 51, lo que da lugar a 9 casos activos más respecto al día 04-01-2021.` 
