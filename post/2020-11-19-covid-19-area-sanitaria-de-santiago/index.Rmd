...
tags:
  - JavaScript
  - R
lastmod: '2021-02-15T13:24:26+02:00'
---

<font color="red"> Actualización: 15-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-15" #para las etiquetas 
fechasemaforo <- "2021-02-15"
fsantiago <-     "2021-02-15"  
...
`A  15-02-2021 en el Área Sanitaria de Santiago se detectaron 26 nuevos casos y se dieron de alta a 149, lo que da lugar a 123 casos activos menos respecto al día 14-02-2021.` 
