...
tags:
  - JavaScript
  - R
lastmod: '2020-12-09T13:23:26+02:00'
---

<font color="red"> Actualización: 09-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-09" #para las etiquetas 
fechasemaforo <- "2020-12-09"
fechacentro <-   "2020-12-05"
fechamapa <-     "2020-12-05"
```
...
`A  09-12-2020 en el Área Sanitaria de Santiago se detectaron 53 nuevos casos y se dieron de alta a 49 y fallecieron dos personas, lo que da lugar a 2 casos activos más respecto al día 08-12-2020.`
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-10-28"), y = 0.8, label = "Cierre hostelería", size = 2) +
            # Apertura hostelería
...
ggplot() +
        ...
        #Eventos poíticos y económicos
          # Cierre hostelería
        geom_vline(xintercept = as_date("2020-11-07"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-28"), y = 25, label = "Cierre hostelería", size = 2) + 
