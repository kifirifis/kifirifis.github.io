...
tags:
  - JavaScript
  - R
lastmod: '2021-06-02T13:24:26+02:00'
---

<font color="red"> Actualización: 02-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-02" #para las etiquetas 
fechasemaforo <- "2021-06-02"
fsantiago <-     "2021-06-02"  
...
`A  02-06-2021 en el Área Sanitaria de Santiago se detectaron 14 nuevos casos, fallecieron 0 personas y se dieron de alta a 10, lo que da lugar a 4 casos activos más respecto al día 01-06-2021.` 
