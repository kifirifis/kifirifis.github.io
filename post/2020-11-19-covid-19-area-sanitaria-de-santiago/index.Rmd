...
tags:
  - JavaScript
  - R
lastmod: '2020-12-01T13:23:26+02:00'
---

<font color="red"> Actualización: 01-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-01" #para las etiquetas 
fechasemaforo <- "2020-12-01"
fechacentro <-   "2020-12-01"
fechamapa <-     "2020-12-01"
```
...
`A  01-12-2020 en el Área Sanitaria de Santiago se detectaron 36 nuevos casos, se dieron de alta a 51, lo que da lugar a 15 casos activos menos respecto al día 30-11-2020.`
