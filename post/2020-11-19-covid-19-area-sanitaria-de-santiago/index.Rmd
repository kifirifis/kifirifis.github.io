...
tags:
  - JavaScript
  - R
lastmod: '2021-05-27T13:24:26+02:00'
---

<font color="red"> Actualización: 27-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-27" #para las etiquetas 
fechasemaforo <- "2021-05-27"
fsantiago <-     "2021-05-27"  
...
`A  27-05-2021 en el Área Sanitaria de Santiago se detectaron 30 nuevos casos, fallecieron 0 personas y se dieron de alta a 28, lo que da lugar a 2 casos activos más respecto al día 26-05-2021.` 
