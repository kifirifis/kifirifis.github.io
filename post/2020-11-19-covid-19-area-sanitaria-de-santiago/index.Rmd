...
tags:
  - JavaScript
  - R
lastmod: '2021-01-14T13:24:26+02:00'
---

<font color="red"> Actualización: 14-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-14" #para las etiquetas 
fechasemaforo <- "2021-01-14"
fsantiago <-     "2021-01-14"  
...
`A  14-01-2021 en el Área Sanitaria de Santiago se detectaron 231 nuevos casos y se dieron de alta a 134, lo que da lugar a 97 casos activos más respecto al día 13-01-2021.` 
