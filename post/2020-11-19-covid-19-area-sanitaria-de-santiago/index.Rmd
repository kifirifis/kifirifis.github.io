...
tags:
  - JavaScript
  - R
lastmod: '2021-05-22T13:24:26+02:00'
---

<font color="red"> Actualización: 22-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-22" #para las etiquetas 
fechasemaforo <- "2021-05-22"
fsantiago <-     "2021-05-22"  

#Centros 
fechacentro <-   "2021-05-20"
fechamapa <-     "2021-05-20"
```
...
`A  22-05-2021 en el Área Sanitaria de Santiago se detectaron 30 nuevos casos, fallecieron 0 personas y se dieron de alta a 30, lo que da lugar a 0 casos activos menos respecto al día 20-05-2021.` 
