...
tags:
  - JavaScript
  - R
lastmod: '2021-03-31T13:24:26+02:00'
---

<font color="red"> Actualización: 31-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-31" #para las etiquetas 
fechasemaforo <- "2021-03-31"
fsantiago <-     "2021-03-31"  
...
`A  31-03-2021 en el Área Sanitaria de Santiago se detectaron 23 nuevos casos, falleció 1 persona y se dieron de alta a 9, lo que da lugar a 13 casos activos más respecto al día 30-03-2021.` 
