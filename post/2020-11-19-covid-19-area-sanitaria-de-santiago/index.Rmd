...
tags:
  - JavaScript
  - R
lastmod: '2021-02-28T13:24:26+02:00'
---

<font color="red"> Actualización: 28-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-28" #para las etiquetas 
fechasemaforo <- "2021-02-28"
fsantiago <-     "2021-02-28"  
...
`A  28-02-2021 en el Área Sanitaria de Santiago se detectaron 15 nuevos casos, falleció 1 persona y se dieron de alta a 71, lo que da lugar a 57 casos activos menos respecto al día 27-02-2021.` 
