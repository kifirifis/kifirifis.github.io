...
tags:
  - JavaScript
  - R
lastmod: '2021-05-24T13:24:26+02:00'
---

<font color="red"> Actualización: 24-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-24" #para las etiquetas 
fechasemaforo <- "2021-05-24"
fsantiago <-     "2021-05-24"  

#Centros 
fechacentro <-   "2021-05-22"
fechamapa <-     "2021-05-22"
```
...
`A  24-05-2021 en el Área Sanitaria de Santiago se detectaron 23 nuevos casos, fallecieron 0 personas y se dieron de alta a 25, lo que da lugar a 2 casos activos menos respecto al día 23-05-2021.` 
