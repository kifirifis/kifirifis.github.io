...
tags:
  - JavaScript
  - R
lastmod: '2021-03-25T13:24:26+02:00'
---

<font color="red"> Actualización: 25-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-25" #para las etiquetas 
fechasemaforo <- "2021-03-25"
fsantiago <-     "2021-03-25"  
...
`A  25-03-2021 en el Área Sanitaria de Santiago se detectaron 16 nuevos casos, fallecieron 1 personas y se dieron de alta a 18, lo que da lugar a 3 casos activos menos respecto al día 24-03-2021.` 
