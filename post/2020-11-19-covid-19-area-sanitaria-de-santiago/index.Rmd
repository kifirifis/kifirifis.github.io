...
tags:
  - JavaScript
  - R
lastmod: '2021-01-01T13:24:26+02:00'
---

<font color="red"> Actualización: 01-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-01" #para las etiquetas 
fechasemaforo <- "2021-01-01"
fsantiago <-     "2021-01-01"  
...
`A  01-01-2021 en el Área Sanitaria de Santiago se detectaron 103 nuevos casos, se dieron de alta a 124 y fallecieron 2 personas, lo que da lugar a 23 casos activos menos respecto al día 30-12-2020.` 
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-10-21"), y = 2, 
...
ggplot() +
        ...
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-21"), y = 70, 
                 label = "Prohibición de \n consumo en interiores\n de bares en Santiago", size = 2) + 
