...
tags:
  - JavaScript
  - R
lastmod: '2021-04-20T13:24:26+02:00'
---

<font color="red"> Actualización: 20-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-20" #para las etiquetas 
fechasemaforo <- "2021-04-20"
fsantiago <-     "2021-04-20"  

#Centros 
fechacentro <-   "2021-04-17"
fechamapa <-     "2021-04-17"
```
...
`A  20-04-2021 en el Área Sanitaria de Santiago se detectaron 14 nuevos casos, fallecieron 0 personas y se dieron de alta a 29, lo que da lugar a 15 casos activos menos respecto al día 19-04-2021.` 
