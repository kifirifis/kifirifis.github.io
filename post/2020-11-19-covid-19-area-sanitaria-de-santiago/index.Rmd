...
tags:
  - JavaScript
  - R
lastmod: '2021-03-13T13:24:26+02:00'
---

<font color="red"> Actualización: 13-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-13" #para las etiquetas 
fechasemaforo <- "2021-03-13"
fsantiago <-     "2021-03-13"  
...
`A  13-03-2021 en el Área Sanitaria de Santiago se detectaron 97 nuevos casos, fallecieron 0 personas y se dieron de alta a 90, lo que da lugar a 7 casos activos más respecto al día 12-03-2021.` 
