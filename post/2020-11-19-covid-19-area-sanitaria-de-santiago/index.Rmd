...
tags:
  - JavaScript
  - R
lastmod: '2020-12-23T13:23:26+02:00'
---

<font color="red"> Actualización: 23-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-23" #para las etiquetas 
fechasemaforo <- "2020-12-23"

fsantiago <-     "2020-12-23"  

fechacentro <-   "2020-12-22"
fechamapa <-     "2020-12-22"
```
...
`A  23-12-2020 en el Área Sanitaria de Santiago se detectaron 80 nuevos casos, se dieron de alta a 56 y fallecieron 2 personas, lo que da lugar a 22 casos activos más respecto al día 22-12-2020.`
