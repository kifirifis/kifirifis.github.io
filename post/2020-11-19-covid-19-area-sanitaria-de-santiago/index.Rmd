...
tags:
  - JavaScript
  - R
lastmod: '2020-12-03T13:23:26+02:00'
---

<font color="red"> Actualización: 03-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-03" #para las etiquetas 
fechasemaforo <- "2020-12-03"
...
`A  03-12-2020 en el Área Sanitaria de Santiago se detectaron 67 nuevos casos, se dieron de alta a 76, lo que da lugar a 9 casos activos menos respecto al día 02-12-2020.`
