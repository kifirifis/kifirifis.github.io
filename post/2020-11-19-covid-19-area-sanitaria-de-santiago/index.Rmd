...
#Centros 
fechacentro <-   "2021-02-10"
fechamapa <-     "2021-02-10"
```
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-09-01"), y = 1, label = "Vuelta al Cole", size = 2) + 
        
            # Vuelta USC
        geom_vline(xintercept = as_date("2020-09-21"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-09-29"), y = 0.6, label = "Vuelta USC", size = 2) + 
            
            # Cierre consumo interior bares santiago 
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-19"), y = 2, 
        ...
        annotate("text", x = as_date("2020-11-17"), y = 2, label = "Cierre hostelería", size = 2) +
  
            # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-22"), y = 0.8, label = "Apertura hostelería", size = 2) + 
        
            # Navidad 
        geom_vline(xintercept = as_date("2020-12-25"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-19"), y = 0.8, label = "Navidad", size = 2) + 
...
ggplot() +
        ...
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-28"), y = 38, label = "Apertura hostelería", size = 2) +
