...
tags:
  - JavaScript
  - R
lastmod: '2021-03-28T13:24:26+02:00'
---

<font color="red"> Actualización: 28-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-28" #para las etiquetas 
fechasemaforo <- "2021-03-28"
fsantiago <-     "2021-03-28"  
...
`A  28-03-2021 en el Área Sanitaria de Santiago se detectaron 19 nuevos casos, fallecieron 0 personas y se dieron de alta a 39, lo que da lugar a 20 casos activos menos respecto al día 27-03-2021.` 
