...
tags:
  - JavaScript
  - R
lastmod: '2021-02-02T13:24:26+02:00'
---

<font color="red"> Actualización: 02-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-02" #para las etiquetas 
fechasemaforo <- "2021-02-02"
fsantiago <-     "2021-02-02"  

#Centros 
fechacentro <-   "2021-02-02"
fechamapa <-     "2021-02-02"
```
...
`A  02-02-2021 en el Área Sanitaria de Santiago se detectaron 169 nuevos casos, se dieron de alta a 138 y fallecieron 7 personas, lo que da lugar a 24 casos activos menos respecto al día 31-01-2021.` 
