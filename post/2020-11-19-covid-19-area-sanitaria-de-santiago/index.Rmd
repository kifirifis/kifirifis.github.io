...
tags:
  - JavaScript
  - R
lastmod: '2021-03-09T13:24:26+02:00'
---

<font color="red"> Actualización: 09-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-09" #para las etiquetas 
fechasemaforo <- "2021-03-09"
fsantiago <-     "2021-03-09"  
...
`A  09-03-2021 en el Área Sanitaria de Santiago se detectaron 13 nuevos casos, falleció 1 persona y se dieron de alta a 20, lo que da lugar a 8 casos activos menos respecto al día 07-03-2021.` 
