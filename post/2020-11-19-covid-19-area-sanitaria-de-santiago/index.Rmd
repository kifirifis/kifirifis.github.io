...
tags:
  - JavaScript
  - R
lastmod: '2021-02-13T13:24:26+02:00'
---

<font color="red"> Actualización: 13-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-13" #para las etiquetas 
fechasemaforo <- "2021-02-13"
fsantiago <-     "2021-02-13"  

#Centros 
fechacentro <-   "2021-02-13"
fechamapa <-     "2021-02-13"
```
...
`A  13-02-2021 en el Área Sanitaria de Santiago se detectaron 64 nuevos casos, se dieron de alta a 291 y fallecieron 4 personas, lo que da lugar a 231 casos activos menos respecto al día 12-02-2021.` 
