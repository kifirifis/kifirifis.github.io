...
tags:
  - JavaScript
  - R
lastmod: '2020-12-22T13:23:26+02:00'
---

<font color="red"> Actualización: 22-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-22" #para las etiquetas 
fechasemaforo <- "2020-12-22"

fsantiago <-     "2020-12-22"  
...
`A  22-12-2020 en el Área Sanitaria de Santiago se detectaron 55 nuevos casos y se dieron de alta a 42, lo que da lugar a 13 casos activos más respecto al día 21-12-2020.`

`- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima. Se mantiene estable.`
