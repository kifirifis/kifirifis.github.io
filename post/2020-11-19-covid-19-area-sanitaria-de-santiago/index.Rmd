...
tags:
  - JavaScript
  - R
lastmod: '2021-01-16T13:24:26+02:00'
---

<font color="red"> Actualización: 16-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-16" #para las etiquetas 
fechasemaforo <- "2021-01-16"
fsantiago <-     "2021-01-16"  
