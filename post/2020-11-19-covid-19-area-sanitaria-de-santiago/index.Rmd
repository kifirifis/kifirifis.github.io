...
tags:
  - JavaScript
  - R
lastmod: '2021-04-26T13:24:26+02:00'
---

<font color="red"> Actualización: 26-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-26" #para las etiquetas 
fechasemaforo <- "2021-04-26"
fsantiago <-     "2021-04-26"  

#Centros 
fechacentro <-   "2021-04-24"
fechamapa <-     "2021-04-24"
```
...
`A  26-04-2021 en el Área Sanitaria de Santiago se detectaron 55 nuevos casos, fallecieron 0 personas y se dieron de alta a 60, lo que da lugar a 5 casos activos menos respecto al día 25-04-2021.` 
