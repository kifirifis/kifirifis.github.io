...
tags:
  - JavaScript
  - R
lastmod: '2020-11-28T13:23:26+02:00'
---

<font color="red"> Actualización: 28-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-11-28" #para las etiquetas 
fechasemaforo <- "2020-11-28"
...
`A  28-11-2020 en el Área Sanitaria de Santiago se detectaron 49 nuevos casos, se dieron de alta a 81, lo que da lugar a 32 casos activos menos respecto al día 27-11-2020.`
