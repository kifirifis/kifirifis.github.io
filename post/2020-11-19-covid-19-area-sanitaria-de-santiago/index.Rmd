...
tags:
  - JavaScript
  - R
lastmod: '2021-03-29T13:24:26+02:00'
---

<font color="red"> Actualización: 29-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-29" #para las etiquetas 
fechasemaforo <- "2021-03-29"
fsantiago <-     "2021-03-29"  
...
`A  29-03-2021 en el Área Sanitaria de Santiago se detectaron 23 nuevos casos, fallecieron 0 personas y se dieron de alta a 8, lo que da lugar a 15 casos activos más respecto al día 28-03-2021.` 
