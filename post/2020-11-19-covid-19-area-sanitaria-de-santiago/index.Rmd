...
tags:
  - JavaScript
  - R
lastmod: '2020-12-30T13:24:26+02:00'
---

<font color="red"> Actualización: 30-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-30" #para las etiquetas 
fechasemaforo <- "2020-12-30"
fsantiago <-     "2020-12-30"  
...
`A  30-12-2020 en el Área Sanitaria de Santiago se detectaron 121 nuevos casos, se dieron de alta a 83 y falleció una persona, lo que da lugar a 37 casos activos más respecto al día 29-12-2020.`
