...
tags:
  - JavaScript
  - R
lastmod: '2021-03-24T13:24:26+02:00'
---

<font color="red"> Actualización: 24-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-24" #para las etiquetas 
fechasemaforo <- "2021-03-24"
fsantiago <-     "2021-03-24"  

#Centros 
fechacentro <-   "2021-03-23"
fechamapa <-     "2021-03-23"
```
...
`A  24-03-2021 en el Área Sanitaria de Santiago se detectaron 13 nuevos casos, fallecieron 2 personas y se dieron de alta a 16, lo que da lugar a 5 casos activos menos respecto al día 22-03-2021.` 
