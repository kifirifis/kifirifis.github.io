...
tags:
  - JavaScript
  - R
lastmod: '2021-02-23T13:24:26+02:00'
---

<font color="red"> Actualización: 23-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-23" #para las etiquetas 
fechasemaforo <- "2021-02-23"
fsantiago <-     "2021-02-23"  
...
`A  23-02-2021 en el Área Sanitaria de Santiago se detectaron 35 nuevos casos, falleció 1 persona y se dieron de alta a 65, lo que da lugar a 31 casos activos menos respecto al día 22-02-2021.` 
