...
tags:
  - JavaScript
  - R
lastmod: '2021-02-24T13:24:26+02:00'
---

<font color="red"> Actualización: 24-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-24" #para las etiquetas 
fechasemaforo <- "2021-02-24"
fsantiago <-     "2021-02-24"  

#Centros 
fechacentro <-   "2021-02-23"
fechamapa <-     "2021-02-23"
```
...
`A  23-02-2021 en el Área Sanitaria de Santiago se detectaron 49 nuevos casos, fallecieron 2 personas y se dieron de alta a 78, lo que da lugar a 31 casos activos menos respecto al día 22-02-2021.` 
