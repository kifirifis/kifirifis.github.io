...
tags:
  - JavaScript
  - R
lastmod: '2021-03-06T13:24:26+02:00'
---

<font color="red"> Actualización: 06-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-06" #para las etiquetas 
fechasemaforo <- "2021-03-06"
fsantiago <-     "2021-03-06"  

#Centros 
fechacentro <-   "2021-03-05"
fechamapa <-     "2021-03-05"
```
...
`A  06-03-2021 en el Área Sanitaria de Santiago se detectaron 21 nuevos casos, falleció 1 persona y se dieron de alta a 29, lo que da lugar a 9 casos activos menos respecto al día 05-03-2021.` 
