...
tags:
  - JavaScript
  - R
lastmod: '2021-05-19T13:24:26+02:00'
---

<font color="red"> Actualización: 19-05-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-05-19" #para las etiquetas 
fechasemaforo <- "2021-05-19"
fsantiago <-     "2021-05-19"  
...
`A  19-05-2021 en el Área Sanitaria de Santiago se detectaron 36 nuevos casos, fallecieron 2 personas y se dieron de alta a 26, lo que da lugar a 8 casos activos más respecto al día 18-05-2021.` 
