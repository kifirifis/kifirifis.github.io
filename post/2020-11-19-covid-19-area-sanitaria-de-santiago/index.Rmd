...
tags:
  - JavaScript
  - R
lastmod: '2020-12-17T13:23:26+02:00'
---

<font color="red"> Actualización: 17-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-17" #para las etiquetas 
fechasemaforo <- "2020-12-17"
fechacentro <-   "2020-12-16"
fechamapa <-     "2020-12-16"
```
...
`A  17-12-2020 en el Área Sanitaria de Santiago se detectaron 110 nuevos casos y se dieron de alta a 63, lo que da lugar a 47 casos activos más respecto al día 16-12-2020.`
