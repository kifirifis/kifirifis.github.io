...
tags:
  - JavaScript
  - R
lastmod: '2021-03-27T13:24:26+02:00'
---

<font color="red"> Actualización: 27-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-27" #para las etiquetas 
fechasemaforo <- "2021-03-27"
fsantiago <-     "2021-03-27"  

#Centros 
fechacentro <-   "2021-03-26"
fechamapa <-     "2021-03-26"
```
...
`A  27-03-2021 en el Área Sanitaria de Santiago se detectaron 12 nuevos casos, fallecieron 0 personas y se dieron de alta a 28, lo que da lugar a 16 casos activos menos respecto al día 26-03-2021.` 

<img src="rmuybajo.png" style="display: inline-block; margin: 0" />  `- La tasa "Proporción PCR+ Media móvil 14 días" está en la categoría 'Riesgo de transmisión bajo'.`
...
ggplot() +
        ...
        annotate("text", x = as_date("2021-03-13"), y = 2, label = "Apertura hostelería", size = 1.8) +
        ...
        expand_limits(x = as_date("2021-03-20")) -> gg4
...
ggplot() +
        ...
        expand_limits(x = as_date("2021-03-20")) -> gg9
...
ggplot() +
        ...
        annotate("text", x = as_date("2021-01-17") + 0.5, y = 90, 
          ...
          # Cierre hostelería 2
        geom_vline(xintercept = as_date("2021-01-27"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-02-2"), y = 38, label = "Cierre hostelería", size = 1.6) +
  
          # Apertura hostelería 2
        geom_vline(xintercept = as_date("2021-02-26"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-03-05"), y = 38, label = "Apertura hostelería", size = 1.6) +
        ...
        expand_limits(x = as_date("2021-03-10")) -> p50
