...
tags:
  - JavaScript
  - R
lastmod: '2021-02-03T13:24:26+02:00'
---

<font color="red"> Actualización: 03-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-03" #para las etiquetas 
fechasemaforo <- "2021-02-03"
fsantiago <-     "2021-02-03"  
...
`A  03-02-2021 en el Área Sanitaria de Santiago se detectaron 129 nuevos casos, se dieron de alta a 201 y fallecieron 4 personas, lo que da lugar a 76 casos activos menos respecto al día 02-02-2021.` 

<img src="ralto.png" style="display: inline-block; margin: 0" />  `- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima. Riesgo de transmisión alto.`
