...
tags:
  - JavaScript
  - R
lastmod: '2021-04-13T13:24:26+02:00'
---

<font color="red"> Actualización: 13-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-13" #para las etiquetas 
fechasemaforo <- "2021-04-13"
fsantiago <-     "2021-04-13"  
...
`A  13-04-2021 en el Área Sanitaria de Santiago se detectaron 26 nuevos casos, falleció 1 persona y se dieron de alta a 13, lo que da lugar a 12 casos activos más respecto al día 12-04-2021.` 
