...
tags:
  - JavaScript
  - R
lastmod: '2021-04-08T13:24:26+02:00'
---

<font color="red"> Actualización: 08-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-08" #para las etiquetas 
fechasemaforo <- "2021-04-08"
fsantiago <-     "2021-04-08"  

#Centros 
fechacentro <-   "2021-03-27"
fechamapa <-     "2021-03-27"
```
...
`A  08-04-2021 en el Área Sanitaria de Santiago se detectaron 23 nuevos casos, fallecieron 0 personas y se dieron de alta a 25, lo que da lugar a 2 casos activos menos respecto al día 06-04-2021.` 
...
ggplot() +
        ...
        annotate("text", x = as_date("2021-04-06"), y = 1.3, label = "Restricciones \nSemana santa", size = 1.8) +
...
ggplot() +
        ...
        annotate("text", x = as_date("2021-03-06"), y = 210, label = "Apertura \nhostelería", size = 1.8) + 
          # Semana santa
        geom_vline(xintercept = as_date("2021-03-29"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-04-05"), y = 210, label = "Restricciones \nSemana santa", size = 1.8) + 
...
ggplot() +
        ...
        annotate("text", x = as_date("2021-03-07"), y = 150, label = "Apertura hostelería", size = 1.6) +
          # Semana santa
        geom_vline(xintercept = as_date("2021-03-29"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-04-05"), y = 150, label = "Restricciones \nSemana santa", size = 1.6) +
