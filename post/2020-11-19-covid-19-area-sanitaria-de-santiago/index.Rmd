...
tags:
  - JavaScript
  - R
lastmod: '2021-02-17T13:24:26+02:00'
---

<font color="red"> Actualización: 17-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-17" #para las etiquetas 
fechasemaforo <- "2021-02-17"
fsantiago <-     "2021-02-17"  
...
`A  17-02-2021 en el Área Sanitaria de Santiago se detectaron 62 nuevos casos, falleció una persona y se dieron de alta a 202, lo que da lugar a 141 casos activos menos respecto al día 16-02-2021.` 
