...
tags:
  - JavaScript
  - R
lastmod: '2021-01-26T13:24:26+02:00'
---

<font color="red"> Actualización: 26-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-26" #para las etiquetas 
fechasemaforo <- "2021-01-26"
fsantiago <-     "2021-01-26"  

#Centros 
fechacentro <-   "2021-01-26"
fechamapa <-     "2021-01-26"
```
...
`A  26-01-2021 en el Área Sanitaria de Santiago se detectaron 239 nuevos casos, se dieron de alta a 110 y fallecieron 5 personas, lo que da lugar a 124 casos activos más respecto al día 23-01-2021.` 
