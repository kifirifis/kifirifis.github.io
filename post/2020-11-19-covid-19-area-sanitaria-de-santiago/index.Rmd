...
tags:
  - JavaScript
  - R
lastmod: '2021-03-17T13:24:26+02:00'
---

<font color="red"> Actualización: 17-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-17" #para las etiquetas 
fechasemaforo <- "2021-03-17"
fsantiago <-     "2021-03-17"  

#Centros 
fechacentro <-   "2021-03-16"
fechamapa <-     "2021-03-16"
```
...
`A  17-03-2021 en el Área Sanitaria de Santiago se detectaron 6 nuevos casos, fallecieron 0 personas y se dieron de alta a 11, lo que da lugar a 5 casos activos menos respecto al día 15-03-2021.` 
