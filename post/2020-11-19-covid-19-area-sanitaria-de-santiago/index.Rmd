...
tags:
  - JavaScript
  - R
lastmod: '2020-12-13T13:23:26+02:00'
---

<font color="red"> Actualización: 13-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-13" #para las etiquetas 
fechasemaforo <- "2020-12-13"
...
`A  13-12-2020 en el Área Sanitaria de Santiago se detectaron 96 nuevos casos y se dieron de alta a 43, lo que da lugar a 53 casos activos más respecto al día 12-12-2020.`
