...
tags:
  - JavaScript
  - R
lastmod: '2021-01-20T13:24:26+02:00'
---

<font color="red"> Actualización: 20-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-20" #para las etiquetas 
fechasemaforo <- "2021-01-20"
fsantiago <-     "2021-01-20"  

#Centros 
fechacentro <-   "2021-01-19"
fechamapa <-     "2021-01-19"
```
...
`A  20-01-2021 en el Área Sanitaria de Santiago se detectaron 190 nuevos casos, se dieron de alta a 101 y fallecieron 4 personas, lo que da lugar a 85 casos activos más respecto al día 19-01-2021.` 
