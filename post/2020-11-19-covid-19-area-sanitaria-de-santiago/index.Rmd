...
tags:
  - JavaScript
  - R
lastmod: '2021-01-11T13:24:26+02:00'
---

<font color="red"> Actualización: 11-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-11" #para las etiquetas 
fechasemaforo <- "2021-01-11"
fsantiago <-     "2021-01-11"  
...
`A  11-01-2021 en el Área Sanitaria de Santiago se detectaron 99 nuevos casos, se dieron de alta a 60 y fallecieron 2 personas, lo que da lugar a 37 casos activos más respecto al día 10-01-2021.` 
