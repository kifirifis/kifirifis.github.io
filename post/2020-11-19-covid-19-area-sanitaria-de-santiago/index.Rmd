...
tags:
  - JavaScript
  - R
lastmod: '2021-06-04T13:24:26+02:00'
---

<font color="red"> Actualización: 04-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-04" #para las etiquetas 
fechasemaforo <- "2021-06-04"
fsantiago <-     "2021-06-04"  
...
`A  04-06-2021 en el Área Sanitaria de Santiago se detectaron 16 nuevos casos, fallecieron 0 personas y se dieron de alta a 28, lo que da lugar a 12 casos activos menos respecto al día 03-06-2021.` 
