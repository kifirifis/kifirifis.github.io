...
tags:
  - JavaScript
  - R
lastmod: '2021-01-12T13:24:26+02:00'
---

<font color="red"> Actualización: 12-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-12" #para las etiquetas 
fechasemaforo <- "2021-01-12"
fsantiago <-     "2021-01-12"  

#Centros 
fechacentro <-   "2021-01-09"
fechamapa <-     "2021-01-09"
```
...
`A  12-01-2021 en el Área Sanitaria de Santiago se detectaron 200 nuevos casos, se dieron de alta a 68 y fallecieron 2 personas, lo que da lugar a 130 casos activos más respecto al día 11-01-2021.` 

<img src="ralto.png" style="display: inline-block; margin: 0" />  `- La tasa "Proporción PCR+ Media móvil 14 días" NO es óptima.`

<img src="rmuyalto.png" style="display: inline-block; margin: 0" /> `- La tasa "Número de casos notificados por cada cien mil habitantes en los últimos 14 días" NO es óptima.`

<img src="rmoderado.png" style="display: inline-block; margin: 0" /> `- Los ratios de los colegios no han bajado y el distanciamiento NO es óptimo.`
...
ggplot() +
        ...
        expand_limits(x = as_date("2021-01-07")) -> gg4
...
ggplot() +
        ...
        # Vuelta al cole
        geom_vline(xintercept = as_date("2020-09-10"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-09-02"), y = 25, label = "Vuelta al Cole", size = 2) + 
        ...
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-20"), y = 70, 
                 label = "Prohibición de \n consumo en interiores\n de bares en Santiago", size = 2) + 
  
          # Cierre hostelería
        geom_vline(xintercept = as_date("2020-11-07"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-16"), y = 55, label = "Cierre hostelería", size = 2) + 
        
          # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-23"), y = 25, label = "Apertura hostelería", size = 2) + 
        
          # Navidad
        geom_vline(xintercept = as_date("2020-12-25"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-20"), y = 25, label = "Navidad", size = 2) + 
        ...
        # annotate("text", x = as_date("2021-01-04"), y = 30, label = "Año\nNuevo", size = 2) + 
          ...
          # Vuelta al Cole Invierno 
        geom_vline(xintercept = as_date("2021-01-08"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-01-13"), y = 65, label = "Vuelta\nal Cole", size = 2) + 
        ...
        expand_limits(x = as_date("2021-01-07")) -> gg9
...
ggplot() +
        ...
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-30"), y = 40, label = "Apertura hostelería", size = 2) +
        
        # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-17"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-13"), y = 40, 
                 label = "Cierre perimetral y \n reducción de aforo", size = 2) +
        
        # Navidad
        geom_vline(xintercept = as_date("2020-12-25"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-23"), y = 40, 
                 label = "Navidad", size = 2) +
        
        # Año nuevo
        geom_vline(xintercept = as_date("2021-01-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-12-30"), y = 40, 
                 label = "Año nuevo", size = 2) +
        
        # Vuelta al Cole Invierno
        geom_vline(xintercept = as_date("2021-01-08"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-01-05"), y = 40, 
        ...
        expand_limits(x = as_date("2021-01-10")) -> p50
