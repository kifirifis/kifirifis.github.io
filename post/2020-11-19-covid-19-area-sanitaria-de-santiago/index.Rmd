...
tags:
  - JavaScript
  - R
lastmod: '2021-01-19T13:24:26+02:00'
---

<font color="red"> Actualización: 19-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-19" #para las etiquetas 
fechasemaforo <- "2021-01-19"
fsantiago <-     "2021-01-19"  
...
`A  19-01-2021 en el Área Sanitaria de Santiago se detectaron 206 nuevos casos, se dieron de alta a 36 y fallecieron 6 personas, lo que da lugar a 164 casos activos más respecto al día 18-01-2021.` 
