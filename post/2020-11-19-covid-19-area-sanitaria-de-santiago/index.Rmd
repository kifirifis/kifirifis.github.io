...
tags:
  - JavaScript
  - R
lastmod: '2020-12-15T13:23:26+02:00'
---

<font color="red"> Actualización: 15-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-15" #para las etiquetas 
fechasemaforo <- "2020-12-15"
...
`A  15-12-2020 en el Área Sanitaria de Santiago se detectaron 78 nuevos casos, falleció una persona y se dieron de alta a 24, lo que da lugar a 53 casos activos más respecto al día 14-12-2020.`
