...
tags:
  - JavaScript
  - R
lastmod: '2021-04-11T13:24:26+02:00'
---

<font color="red"> Actualización: 11-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-11" #para las etiquetas 
fechasemaforo <- "2021-04-11"
fsantiago <-     "2021-04-11"  

#Centros 
fechacentro <-   "2021-04-10"
fechamapa <-     "2021-04-10"
```
...
`A  11-04-2021 en el Área Sanitaria de Santiago se detectaron 28 nuevos casos, fallecieron 0 personas y se dieron de alta a 20, lo que da lugar a 8 casos activos más respecto al día 10-04-2021.` 
