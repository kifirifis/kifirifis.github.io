...
tags:
  - JavaScript
  - R
lastmod: '2021-03-16T13:24:26+02:00'
---

<font color="red"> Actualización: 16-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-16" #para las etiquetas 
fechasemaforo <- "2021-03-16"
fsantiago <-     "2021-03-16"  
...
`A  16-03-2021 en el Área Sanitaria de Santiago se detectaron 8 nuevos casos, fallecieó 1 persona y se dieron de alta a 13, lo que da lugar a 6 casos activos menos respecto al día 15-03-2021.` 
