...
tags:
  - JavaScript
  - R
lastmod: '2021-02-22T13:24:26+02:00'
---

<font color="red"> Actualización: 22-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-22" #para las etiquetas 
fechasemaforo <- "2021-02-22"
fsantiago <-     "2021-02-22"  
...
`A  22-02-2021 en el Área Sanitaria de Santiago se detectaron 21 nuevos casos, falleció 1 persona y se dieron de alta a 101, lo que da lugar a 81 casos activos menos respecto al día 21-02-2021.` 
