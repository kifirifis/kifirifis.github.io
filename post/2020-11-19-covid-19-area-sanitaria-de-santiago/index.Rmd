...
tags:
  - JavaScript
  - R
lastmod: '2021-03-15T13:24:26+02:00'
---

<font color="red"> Actualización: 15-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-15" #para las etiquetas 
fechasemaforo <- "2021-03-15"
fsantiago <-     "2021-03-15"  
...
`A  15-03-2021 en el Área Sanitaria de Santiago se detectaron 7 nuevos casos, fallecieron 2 personas y se dieron de alta a 13, lo que da lugar a 8 casos activos menos respecto al día 14-03-2021.` 
