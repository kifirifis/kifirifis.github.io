...
tags:
  - JavaScript
  - R
lastmod: '2021-06-10T13:24:26+02:00'
---

<font color="red"> Actualización: 10-06-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-06-10" #para las etiquetas 
fechasemaforo <- "2021-06-10"
fsantiago <-     "2021-06-10"  

#Centros 
fechacentro <-   "2021-06-08"
fechamapa <-     "2021-06-08"
```
...
`A  09-06-2021 en el Área Sanitaria de Santiago se detectaron 15 nuevos casos, fallecieron 0 personas y se dieron de alta a 76, lo que da lugar a 61 casos activos menos respecto al día 08-06-2021.` 
