...
tags:
  - JavaScript
  - R
lastmod: '2021-04-03T13:24:26+02:00'
---

<font color="red"> Actualización: 03-04-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago.  Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-04-03" #para las etiquetas 
fechasemaforo <- "2021-04-03"
fsantiago <-     "2021-04-03"  
...
`A  03-04-2021 en el Área Sanitaria de Santiago se detectaron 21 nuevos casos, fallecieron 0 personas y se dieron de alta a 12, lo que da lugar a 9 casos activos más respecto al día 02-04-2021.` 
