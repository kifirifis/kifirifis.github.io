...
tags:
  - JavaScript
  - R
lastmod: '2020-12-07T13:23:26+02:00'
---

<font color="red"> Actualización: 07-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-07" #para las etiquetas 
fechasemaforo <- "2020-12-07"
...
`A  07-12-2020 en el Área Sanitaria de Santiago se detectaron 47 nuevos casos y se dieron de alta a 36, lo que da lugar a 11 casos activos más respecto al día 06-12-2020.`
