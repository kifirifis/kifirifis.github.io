...
tags:
  - JavaScript
  - R
lastmod: '2021-03-19T13:24:26+02:00'
---

<font color="red"> Actualización: 19-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-19" #para las etiquetas 
fechasemaforo <- "2021-03-19"
fsantiago <-     "2021-03-19"  

#Centros 
fechacentro <-   "2021-03-18"
fechamapa <-     "2021-03-18"
```
...
`A  19-03-2021 en el Área Sanitaria de Santiago se detectaron 10 nuevos casos, falleció 1 persona y se dieron de alta a 13, lo que da lugar a 4 casos activos menos respecto al día 18-03-2021.` 
