...
tags:
  - JavaScript
  - R
lastmod: '2020-12-23T13:24:26+02:00'
---

<font color="red"> Actualización: 24-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-24" #para las etiquetas 
fechasemaforo <- "2020-12-24"
fsantiago <-     "2020-12-24"  
...
`A  24-12-2020 en el Área Sanitaria de Santiago se detectaron 114 nuevos casos y se dieron de alta a 63, lo que da lugar a 51 casos activos más respecto al día 23-12-2020.`
