...
tags:
  - JavaScript
  - R
lastmod: '2021-02-25T13:24:26+02:00'
---

<font color="red"> Actualización: 25-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-25" #para las etiquetas 
fechasemaforo <- "2021-02-25"
fsantiago <-     "2021-02-25"  

#Centros 
fechacentro <-   "2021-02-24"
fechamapa <-     "2021-02-24"
```
...
`A  25-02-2021 en el Área Sanitaria de Santiago se detectaron 43 nuevos casos, fallecieron 2 personas y se dieron de alta a 106, lo que da lugar a 65 casos activos menos respecto al día 24-02-2021.` 
...
ggplot() +
        ...
        annotate("text", x = as_date("2020-09-01"), y = 1, label = "Vuelta al Cole", size = 1.8) + 
        
            # Vuelta USC
        geom_vline(xintercept = as_date("2020-09-21"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-09-29"), y = 0.6, label = "Vuelta USC", size = 1.8) + 
            
            # Cierre consumo interior bares santiago 
        geom_vline(xintercept = as_date("2020-11-01"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-10-18"), y = 2, 
        ...
        annotate("text", x = as_date("2020-11-17"), y = 2, label = "Cierre hostelería", size = 1.8) +
  
            # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-22"), y = 0.8, label = "Apertura hostelería", size = 1.8) + 
        ...
        annotate("text", x = as_date("2021-02-07"), y = 2, label = "Cierre hostelería", size = 1.8) +
...
ggplot() +
        ...
        # Vuelta al cole
        geom_vline(xintercept = as_date("2020-09-10"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-09-01"), y = 25, label = "Vuelta al Cole", size = 1.8) + 
  
        # Vuelta USC
        geom_vline(xintercept = as_date("2020-09-21"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-09-28"), y = 25, label = "Vuelta USC", size = 1.8) + 
        ...
        annotate("text", x = as_date("2020-10-19"), y = 70, 
          ...
          # Cierre hostelería
        geom_vline(xintercept = as_date("2020-11-07"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-17"), y = 55, label = "Cierre hostelería", size = 1.8) + 
        
          # Apertura hostelería
        geom_vline(xintercept = as_date("2020-12-04"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2020-11-22"), y = 25, label = "Apertura hostelería", size = 1.8) + 
        ...
        annotate("text", x = as_date("2021-01-25"), y = 130, 
          ...
          # Cierre hostelería
        geom_vline(xintercept = as_date("2021-01-27"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-02-07"), y = 210, label = "Cierre hostelería", size = 1.8) + 
...
ggplot() +
        ...
        annotate("text", x = as_date("2021-01-16") + 0.5, y = 90, 
                 label = "Prohibición de consumo \n en interiores de bares \n y cierre a las 18:00", size = 1.8) +
          # Cierre hostelería 2
        geom_vline(xintercept = as_date("2021-01-27"), linetype = 2, alpha = 0.6) +
        annotate("text", x = as_date("2021-02-2"), y = 38, label = "Cierre hostelería", size = 1.8) +
