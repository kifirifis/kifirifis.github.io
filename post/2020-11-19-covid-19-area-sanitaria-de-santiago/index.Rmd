...
tags:
  - JavaScript
  - R
lastmod: '2021-02-07T13:24:26+02:00'
---

<font color="red"> Actualización: 08-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-08" #para las etiquetas 
fechasemaforo <- "2021-02-08"
fsantiago <-     "2021-02-08"  
...
`A  08-02-2021 en el Área Sanitaria de Santiago se detectaron 73 nuevos casos, se dieron de alta a 160 y fallecieron 4 personas, lo que da lugar a 91 casos activos menos respecto al día 07-02-2021.` 
