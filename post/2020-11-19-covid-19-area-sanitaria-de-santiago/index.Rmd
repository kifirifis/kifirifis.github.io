...
tags:
  - JavaScript
  - R
lastmod: '2021-01-17T13:24:26+02:00'
---

<font color="red"> Actualización: 17-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-17" #para las etiquetas 
fechasemaforo <- "2021-01-17"
fsantiago <-     "2021-01-17"  

#Centros 
fechacentro <-   "2021-01-15"
fechamapa <-     "2021-01-15"
```
...
`A  16-01-2021 en el Área Sanitaria de Santiago se detectaron 211 nuevos casos, se dieron de alta a 132 y fallecieron 4 personas, lo que da lugar a 75 casos activos más respecto al día 14-01-2021.` 
...
ggplot() +
        ...
        scale_alpha_identity(guide = "none") +
        scale_y_continuous(expand = c(0, 0), limits = c(0, 530)) +
