...
tags:
  - JavaScript
  - R
lastmod: '2021-03-08T13:24:26+02:00'
---

<font color="red"> Actualización: 08-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-08" #para las etiquetas 
fechasemaforo <- "2021-03-08"
fsantiago <-     "2021-03-08"  
...
`A  08-03-2021 en el Área Sanitaria de Santiago se detectaron 11 nuevos casos, fallecieron 2 personas y se dieron de alta a 27, lo que da lugar a 18 casos activos menos respecto al día 07-03-2021.` 
