...
tags:
  - JavaScript
  - R
lastmod: '2020-12-05T13:23:26+02:00'
---

<font color="red"> Actualización: 05-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-05" #para las etiquetas 
fechasemaforo <- "2020-12-05"
fechacentro <-   "2020-12-04"
fechamapa <-     "2020-12-04"
```
...
`A  05-12-2020 en el Área Sanitaria de Santiago se detectaron 61 nuevos casos, se dieron de alta a 74 y falleció una persona, lo que da lugar a 14 casos activos menos respecto al día 04-12-2020.`
