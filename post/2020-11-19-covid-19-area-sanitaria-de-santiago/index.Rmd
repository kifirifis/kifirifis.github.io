...
tags:
  - JavaScript
  - R
lastmod: '2021-03-07T13:24:26+02:00'
---

<font color="red"> Actualización: 07-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-07" #para las etiquetas 
fechasemaforo <- "2021-03-07"
fsantiago <-     "2021-03-07"  

#Centros 
fechacentro <-   "2021-03-06"
fechamapa <-     "2021-03-06"
```
...
`A  07-03-2021 en el Área Sanitaria de Santiago se detectaron 15 nuevos casos, fallecieron 0 personas y se dieron de alta a 61, lo que da lugar a 46 casos activos menos respecto al día 06-03-2021.` 
