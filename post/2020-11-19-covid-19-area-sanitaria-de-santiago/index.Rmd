...
tags:
  - JavaScript
  - R
lastmod: '2021-03-04T13:24:26+02:00'
---

<font color="red"> Actualización: 04-03-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-03-04" #para las etiquetas 
fechasemaforo <- "2021-03-04"
fsantiago <-     "2021-03-04"  
...
`A  04-03-2021 en el Área Sanitaria de Santiago se detectaron 19 nuevos casos, fallecieron 2 personas y se dieron de alta a 67, lo que da lugar a 50 casos activos menos respecto al día 03-03-2021.` 
