...
tags:
  - JavaScript
  - R
lastmod: '2020-12-21T13:23:26+02:00'
---

<font color="red"> Actualización: 21-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-21" #para las etiquetas 
fechasemaforo <- "2020-12-21"

fsantiago <-     "2020-12-21"  

fechacentro <-   "2020-12-19"
fechamapa <-     "2020-12-19"
```
...
`A  21-12-2020 en el Área Sanitaria de Santiago se detectaron 64 nuevos casos, se dieron de alta a 44 y falleció una persona, lo que da lugar a 19 casos activos más respecto al día 20-12-2020.`
