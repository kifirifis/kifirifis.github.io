...
tags:
  - JavaScript
  - R
lastmod: '2021-02-27T13:24:26+02:00'
---

<font color="red"> Actualización: 27-02-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-02-27" #para las etiquetas 
fechasemaforo <- "2021-02-27"
fsantiago <-     "2021-02-27"  

#Centros 
fechacentro <-   "2021-02-26"
fechamapa <-     "2021-02-26"
```
...
`A  27-02-2021 en el Área Sanitaria de Santiago se detectaron 17 nuevos casos, fallecieron 0 personas y se dieron de alta a 66, lo que da lugar a 49 casos activos menos respecto al día 26-02-2021.` 
