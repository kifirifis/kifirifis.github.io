...
tags:
  - JavaScript
  - R
lastmod: '2020-12-06T13:23:26+02:00'
---

<font color="red"> Actualización: 06-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-06" #para las etiquetas 
fechasemaforo <- "2020-12-06"
...
`A  06-12-2020 en el Área Sanitaria de Santiago se detectaron 52 nuevos casos y se dieron de alta a 75, lo que da lugar a 23 casos activos menos respecto al día 05-12-2020.`
