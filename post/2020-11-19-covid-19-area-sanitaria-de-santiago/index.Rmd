...
tags:
  - JavaScript
  - R
lastmod: '2021-01-10T13:24:26+02:00'
---

<font color="red"> Actualización: 10-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-10" #para las etiquetas 
fechasemaforo <- "2021-01-10"
fsantiago <-     "2021-01-10"  
...
`A  10-01-2021 en el Área Sanitaria de Santiago se detectaron 98 nuevos casos y se dieron de alta a 106, lo que da lugar a 8 casos activos menos respecto al día 09-01-2021.` 
