...
tags:
  - JavaScript
  - R
lastmod: '2021-01-02T13:24:26+02:00'
---

<font color="red"> Actualización: 02-01-2021 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2021-01-02" #para las etiquetas 
fechasemaforo <- "2021-01-02"
fsantiago <-     "2021-01-02"  
...
`A  02-01-2021 en el Área Sanitaria de Santiago se detectaron 122 nuevos casos y dieron de alta a 112, lo que da lugar a 10 casos activos más respecto al día 01-01-2021.` 
