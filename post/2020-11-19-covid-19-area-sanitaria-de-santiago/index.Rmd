...
tags:
  - JavaScript
  - R
lastmod: '2020-12-20T13:23:26+02:00'
---

<font color="red"> Actualización: 20-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-20" #para las etiquetas 
fechasemaforo <- "2020-12-20"

fsantiago <-     "2020-12-20"  
...
`A  20-12-2020 en el Área Sanitaria de Santiago se detectaron 81 nuevos casos y se dieron de alta a 60, lo que da lugar a 21 casos activos más respecto al día 19-12-2020.`
