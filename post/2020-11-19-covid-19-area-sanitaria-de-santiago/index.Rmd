...
tags:
  - JavaScript
  - R
lastmod: '2020-11-27T13:23:26+02:00'
---

<font color="red"> Actualización: 27-11-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-11-27" #para las etiquetas 
fechasemaforo <- "2020-11-27"
fechacentro <-   "2020-11-26"
fechamapa <-     "2020-11-26"
```
...
`A  27-11-2020 en el Área Sanitaria de Santiago se detectaron 57 nuevos casos, se dieron de alta a 74 y fallecieron 2 personas, lo que da lugar a 19 casos activos menos respecto al día 25-11-2020.`
