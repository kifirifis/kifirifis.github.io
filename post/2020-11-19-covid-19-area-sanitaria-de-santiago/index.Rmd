...
tags:
  - JavaScript
  - R
lastmod: '2020-12-25T13:24:26+02:00'
---

<font color="red"> Actualización: 25-12-2020 </font>.[^1] COVID-19 en el Área Sanitaria de Santiago. Semáforo para Centros Educativos.

[^1]: Esta página se actualiza diariamente

```{r echo=FALSE, message=F, warning=F}
fechaactual <-   "2020-12-25" #para las etiquetas 
fechasemaforo <- "2020-12-25"
...
`A  25-12-2020 en el Área Sanitaria de Santiago se detectaron 78 nuevos casos y se dieron de alta a 76, lo que da lugar a 2 casos activos más respecto al día 23-12-2020.`
